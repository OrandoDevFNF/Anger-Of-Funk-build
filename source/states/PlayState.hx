...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Too bad bro', 0.2], //From 0% to 19%
		['Too slow', 0.4], //From 20% to 39%
		['Nice', 0.5], //From 40% to 49%
		['Ok', 0.6], //From 50% to 59%
		['Medium', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
		['Good', 0.8], //From 70% to 79%
		['Greateful', 0.9], //From 80% to 89%
		['You sick!', 1], //From 90% to 99%
		['CommunityGame!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
